...
public class RawMaterialAdapter extends RecyclerView.Adapter<RawMaterialAdapter.MaterialViewHolder> {
    ...
    public interface OnDeleteClickListener {
        void onDeleteClick(String materialId);
    }
    ...
    public void onBindViewHolder(@NonNull MaterialViewHolder holder, int position) {
        ...
        holder.bind(material, deleteListener);
    }
    ...
    static class MaterialViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(RawMaterial material, OnDeleteClickListener deleteListener) {
            nameText.setText(material.getName());
            cropText.setText(String.format("Crop: %s", material.getCrop() != null ? material.getCrop() : "N/A"));
            ...
            dateText.setText(String.format("Date: %s", material.getDate() != null ? material.getDate() : "N/A"));

            deleteButton.setOnClickListener(v -> {
                if (deleteListener != null) {
                    deleteListener.onDeleteClick(material.getMaterialId());
                }
            });
        }
    }
